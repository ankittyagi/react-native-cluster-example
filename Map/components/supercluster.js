...
SuperCluster.prototype = {
    ...
    _cluster: function (points, zoom) {
        ...
        for (var i = 0; i < points.length; i++) {
            ...
            var custom_value = p.custom_value || 0;
            ...
            for (var j = 0; j < neighborIds.length; j++) {
                ...
                var custom_value2 = b.custom_value || 0;
                var numPoints2 = b.numPoints || 1;
                wx += b.x * numPoints2; // accumulate coordinates for calculating weighted center
                wy += b.y * numPoints2;

                custom_value += custom_value2;
            ...
            if (numPoints === 1) {
                ...
                p.parentId = i;
                clusters.push(createCluster(wx / numPoints, wy / numPoints, i, numPoints, clusterProperties, custom_value));
            }
        }
...
function createCluster(x, y, id, numPoints, properties, custom_value) {
    return {
...
function getClusterProperties(cluster) {
    ...
    var custom_value = cluster.custom_value;
